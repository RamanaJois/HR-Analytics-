...
# install.packages()- used to install a package in our collection of packages in R whose functions we wish to use. Done only once.
# library()- Used when we wish to call the functions of an already installed package.
# help()- Gives details of the dataset

# ls()- returns all the variables present in the R sessions across the scripts.
ls()
list=ls()
# rm()- removes all the variables present in the R sessions across the scripts.
rm(list=ls())
ls()
